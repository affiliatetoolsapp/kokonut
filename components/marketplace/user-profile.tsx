...
import { LogOut, MoveUpRight, Settings, CreditCard, FileText, UserCircle, Building, Bell } from "lucide-react"
...
interface UserProfileProps {
  ...
  role: string
  avatar: string
  accountType?: "admin" | "affiliate" | "advertiser"
}
...
export default function UserProfile({
  ...
  const menuItems: MenuItem[] = [
    {
      label: "Account Type",
      value: accountType === "admin" ? "Administrator" : accountType === "affiliate" ? "Affiliate" : "Advertiser",
      href: "#",
      icon:
        accountType === "admin" ? (
